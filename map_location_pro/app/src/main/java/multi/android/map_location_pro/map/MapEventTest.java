...
/*
*  지도화면이 출련된 후에 이벤트를 연결할 수 있어야 한다. 지도를 클릭하거나 지도를 드래그하거나
* 지도를 줌레벨 버튼을 이용해서 줌레벨을 변경
*          OnMapClickListener => 지도를 클릭할때 발생하는 이벤트에 대한 처리
*          OnMapLongClickListener => 맵을 길게 눌렀을때 발생하는 이벤트에 대한 처리
*          지도의 위치가 바뀌거나 줌레벨이 변경되면 발생하는 이벤트에 대한 처리
*          OnCameraMoveListner => 지도의 위치가 바뀌거나 줌레벨이 변경되어 카메라가 이동할때 이벤트에 대한 처리
*          OnCameraMoveStartedListener => 지도의 위치가 바뀌거나 줌레벨이 변경되어 카메라가 이동되기 시작할때 이벤트에 대한 처리
*          [순서]
*              OnCameraMoveStartedListener => OnCameraMoveListner
*/
public class MapEventTest extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapClick(LatLng latLng) {
        ...
        circleOptions.fillColor(Color.parseColor("#550FF0BC"));
    ...
    public void onCameraMoveStarted(int i) {
        Toast.makeText(this,"카메라가 이동이 시작됩니다.",Toast.LENGTH_SHORT).show();
    }
}
