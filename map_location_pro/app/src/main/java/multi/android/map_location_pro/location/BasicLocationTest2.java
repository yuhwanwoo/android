...
//위치정보를 제공하는 객체의 종류와 현재 사용할 수 있는 위치 정보 제공자를 확인
//오류상황 - avd에서 gps모듈을 제공하지 않는다.
//                      확인하고 사용할 수 있도록 작업(GPS,NETWORK모듈을 함께 호출해서 먼저 받아지는 Provider를 이용해서
//                      작업할 수 있도록 구현)
public class BasicLocationTest2 extends AppCompatActivity implements LocationListener {
    ...
    //위치정보를 출력하는 메소드
    public void pringInfo(String provider,Location location){
        String msg="";
        if (location != null) {
