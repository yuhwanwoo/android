...
public class BaicAppRun extends AppCompatActivity {
    //승인받을 권한의 목록
    String[] permisiion_list={
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baic_app_run);
        //권한체크 메소드를 호출
        runPermission();
    }
    //구글맵실행
    ...
    public void runWeb(View v){
        Uri uri=Uri.parse("http://m.daum.net");
        Intent intent = new Intent(Intent.ACTION_VIEW,uri);
        startActivity(intent);
    }
    //전화걸기화면만 실행
    ...
    public void runPermission(){
        ...
        //모든 권한을 셀프체크
        for(String permission:permisiion_list){
